		...
		<div class="row">
			...
			<div class="col content">
				<div class="row">
					...
					<div class="col-md-12 rangkuman-green">
						<h6>Mahasiswa Ini Sudah Lengkap</h6>
					</div>
				</div>
				<div class="row">
					...
					<div class="col info-mhs">
						...
						<div class="col info-container">
							...
							<p><b>Tahun Angkatan : </b> 2022</p>
							<p><b>IPK : </b> 3.50</p>
							<p><b>SKS Total : </b> 60</p>
						</div>
				...
				<div class="row">
					...
					<div class="col info-mhs">
						<div class="col-md-3 info-container">
							...
							<p><b>Tingkat III : </b> - SKS</p>
							<p><b>Tingkat IV : </b> - SKS</p>
						</div>
						<div class="col info-container">
							<p><b>Lulus tanggal 25-02-2022: </b> IP : 3.88</p>
							<p><b>Belum lulus </b> IP : 3.60</p>
							<p><b>Belum lulus </b> IP : 3.60</p>
							<p><b>Belum lulus </b> IP : 3.60</p>
						</div>
			...
			<div class="col-md-12 matkul-uncheck" id="mk-wajib">
				<div class="col widget-checkup">
					<div class="col-md-12 top-part">
						<h3>Mata Kuliah Wajib Belum Diambil<i title="Menampilkan Mata kuliah yang belum diambil di tingkat setara dan sebelumnya" class="fa-solid fa-circle-info"></i></h3>
					</div>
					<?php if (empty($data)): ?>
						<p class="text-center">Matkul tingkat ini dan sebelumnya sudah lengkap diambil</p>
					<?php else: ?>
						<table class="table">
							<thead>
								<tr>
		...
		<div class="row">
			<div class="col-md-12 matkul-uncheck" id="mk-ulang">
				<div class="col widget-checkup">
					...
					<?php if (empty($data_mk_repeat)): ?>
						<p class="text-center">Tidak ada matkul yang perlu diulang</p>
					<?php else: ?>
						<table class="table">
							<thead>
								<tr>
		...
		<div class="row">
			<div class="col-md-12 matkul-uncheck" id="mk-pilihan">
				<div class="col widget-checkup">
					...
					<?php if (empty($data_mkpil_repeat)): ?>
						<p class="text-center">Mahasiswa ini belum masuk ke tingkat 3</p>
					<?php else: ?>
						<table class="table">
							<thead>
								<tr>
...
<script type="text/javascript">
    ...
    type: 'bar',
    data: {
      labels: ['2021/1 (smt 1)', '2021/2 (smt 2)', '2122/1 (smt 3)', '2122/2 (smt 4)'],
      datasets: [{
        label: 'IPK',
        data: [3.80, 3.20, 3.30, 3.60],
        backgroundColor: [
	      'rgba(75, 192, 192, 0.2)',
	      'rgba(75, 192, 192, 0.2)',
	      'rgba(75, 192, 192, 0.2)',
